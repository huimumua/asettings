...
public class AudioRecordActivity extends SecondBaseActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView(getResources().getString(R.string.audio_recording),R.drawable.icon_submenu_mov_rec_setting, menuInfo, R.layout.second_menu_layout);
    ...
    private void focusItem() {
        ...
        settingValue = Settings.Global.getInt(contentResolver, AskeySettings.Global.RECSET_VOICE_RECORD, 1);
        if (settingValue == 0) {
            focusPosition = 1;//OFF
